...
SECRET_KEY = 'django-insecure-8r+n(tecx83irpf7d6bi5&a#-)c8*5&5716_o5g3+$2p6b+9ce'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ecommerce_db',       # Nama database MySQL yang telah Anda buat
        'USER': 'root',   # Username MySQL Anda
        'PASSWORD': 'Password12345',   # Password MySQL Anda
